...
export type ItemType = 'arma' | 'armadura' | 'escudo' | 'pedra-magica' | 'pergaminho' | 'acessorio' | 'consumivel' | 'utensilio' | 'cajado';
...
export const items: Item[] = [
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/espada_oricalco.png',
    stats: { damage: '10 + 2d5' },
    weight: 'médio',
    hands: 'uma mão',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/socoingles_espinhos.png',
    stats: { damage: '4 + d5' },
    weight: 'leve',
    hands: 'duas mãos',
    attribute: 'Força',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/socoingles_lamina.png',
    stats: { damage: '6 + d6' },
    weight: 'leve',
    hands: 'duas mãos',
    attribute: 'Força',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/socoingles_flesha.png',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/adaga_assassina.png',
    stats: { damage: '5 + d4' },
    weight: 'leve',
    hands: 'uma mão',
    attribute: 'Força',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/adaga_oricalco.png',
    stats: { damage: '6 + d6' },
    weight: 'leve',
    hands: 'uma mão',
    attribute: 'Força',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/chicote_espinho.png',
    stats: { damage: 'd14' },
    weight: 'médio',
    hands: 'uma mão',
    attribute: 'Destreza',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/chicote_oricalco.png',
    stats: { damage: 'd25' },
    weight: 'médio',
    hands: 'uma mão',
    attribute: 'Destreza',
  ...
  // ===================== MACHADOS =====================
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/machado_simples.png',
    stats: { damage: '6 + d6' },
    weight: 'pesado',
    hands: 'duas mãos',
    attribute: 'Força',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/machado_guerra.png',
    stats: { damage: '10 + d10' },
    weight: 'pesado',
    hands: 'duas mãos',
    attribute: 'Força',
  ...
  },
  {
    ...
    type: 'arma',
    typeLabel: 'Arma',
    image: '/items/machado_oricalco.png',
    stats: { damage: '14 + d12' },
    weight: 'pesado',
    hands: 'duas mãos',
    attribute: 'Força',
  ...
  // ===================== ESCUDOS =====================
  {
    ...
    image: '/items/escudo_madeira.png',
    weight: 'médio',
    hands: 'uma mão',
  },
  {
  ...
  },
  {
    ...
    image: '/items/escudo_magico_F.png',
    weight: 'médio',
    hands: 'uma mão',
  ...
  },
  {
    ...
    image: '/items/escudo_mithril.png',
    weight: 'médio',
    hands: 'uma mão',
  ...
  },
  {
    ...
    image: '/items/escudo_oricalco.png',
    weight: 'médio',
    hands: 'uma mão',
  ...
  // ===================== ARMADURAS =====================
  {
    ...
    type: 'armadura',
    typeLabel: 'Armadura',
    image: '/items/armadura_couro.png',
    stats: { armor: 1 },
    weight: 'leve',
  },
  {
    ...
    type: 'armadura',
    typeLabel: 'Armadura',
    image: '/items/armadura_prata.png',
    stats: { armor: 3 },
    weight: 'médio',
  },
  {
    ...
    type: 'armadura',
    typeLabel: 'Armadura',
    image: '/items/armadura_escamas.png',
    stats: { magic: 3 },
    weight: 'médio',
    effects: ['Proteção mágica: reduz dano de magias'],
  },
  {
    ...
    type: 'armadura',
    typeLabel: 'Armadura',
    image: '/items/armadura_mithril_banhada.png',
  ...
  },
  {
    ...
    type: 'armadura',
    typeLabel: 'Armadura',
    image: '/items/armadura_mithril.png',
    stats: { armor: 5, magic: 5 },
    weight: 'médio',
  ...
  },
  {
    ...
    type: 'armadura',
    typeLabel: 'Armadura',
    image: '/items/armadura_escamas_forte.png',
    stats: { magic: 7 },
    weight: 'médio',
...

  {
    ...
    name: 'Cajado',
    description:
      'Cajados são armas para magos, eles tem marias variações dependendo do seu material, podendo dar poder magico a criaturas que não conseguem usar magiar normalmente ou adicionando nado ou vantagem com algum tipo de magia.',
    rarity: 'comum',
    rarityLabel: 'Comum',
    type: 'cajado',
    typeLabel: 'Cajado',
    image: '/items/cajado.png',
    stats: { magic: 10 },
    weight: 'leve',
  },
  ...
  },
  {
    ...
    name: 'Poção de Mana',
    description:
      'Líquido azul em frasco de vidro. Ao ser ingerido, restaura imediatamente 8 pontos de mana fixos mais um dado de 4 faces (8 + d4). Uma das preparações mais comuns e buscadas nos mercados de Terrenor.',
    rarity: 'incomum',
    rarityLabel: 'Incomum',
    type: 'consumivel',
    typeLabel: 'Consumível',
    image: '/items/pocao_mana.png',
    effects: ['Cura: 8 + d4 MP'],
    weight: 'leve',
  },
];
