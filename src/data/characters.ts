export const characters = [
    {
        id: 'draconis-ignis',
        name: 'Draconis Ignis',
        title: 'Rei Fênix de Drakoria',
        description: 'Sobreviveu a inúmeras batalhas e fundou a Casa do Recomeço. Lidera Drakoria com sabedoria ancestral.',
        image: '/characters/draconis-ignis.png',
        type: 'notavel'
    },
    {
        id: 'salazar-veyran',
        name: 'Salazar Veyran',
        title: 'Príncipe das Moedas',
        description: 'Mercador genial ou líder do submundo? Sua influência é incontestável em Mystralia e em todo o continente.',
    ...
    },
    {
        id: 'juiz-wulfran',
        name: 'Juiz Wulfran',
        title: 'Seguidor da Ordem Silenciosa',
        description: 'Austero comandante de Grimfort, responsável por manter o equilíbrio e o silêncio ritual nos cemitérios dos reis.',
        image: '/characters/juiz-wulfran.png',
        type: 'notavel'
    },
    {
        id: 'aeryndor',
        name: 'Aeryndor',
        title: 'Guardião da Árvore',
        description: 'Espírito ancestral em forma corpórea. Protege Ravenpeak e surge como aliado inabalável em tempos de crise.',
        image: '/characters/semImagem.png',
        type: 'notavel'
    },
    {
        id: 'crianca-livre',
        name: 'A Criança Livre de Doenças',
        title: 'Lenda da Purificação',
        description: 'Fala-se de uma criança nascida imune a qualquer tipo de magia ou contaminação. Sua existência representa a possibilidade da purificação — ou o despertar do desequilíbrio.',
        type: 'mito'
    },
    {
        id: 'nove-circulos',
        name: 'Os Nove Círculos de Sal',
        title: 'Seita Misteriosa',
        description: 'Uma seita misteriosa que selou magias proibidas em templos espalhados pelo deserto. Dizem que quem quebra um desses selos nunca mais dorme da mesma forma.',
        type: 'mito'
    },
    {
        id: 'fenix-eterna',
        name: 'A Fênix Eterna',
        title: 'Entidade Mitológica',
        description: 'Entidade mitológica adorada por alguns como um deus do renascimento. Alguns acreditam que a fênix não é um ser, mas sim um ciclo — e que seu retorno trará imortalidade a quem a servir.',
        type: 'mito'
    },
    {
        id: 'espelho-mundos',
        name: 'O Espelho dos Mundos',
        title: 'Artefato Enlouquecedor',
        description: 'Artefato fragmentado que revelava não apenas o futuro, mas o "possível que não deveria ser". Enlouqueceu magos e reis. Seus fragmentos ainda são caçados.',
        type: 'mito'
    },
    {
        id: 'arauto-renascimento',
        name: 'O Arauto do Renascimento',
        title: 'Figura Enigmática',
        description: 'Velhos contos falam de uma figura encapuzada, com olhos como carvão em brasas, que surge nas bordas do mundo sempre que a imortalidade volta a ser desejada. Ninguém sabe se ele é um ou muitos. Mas sempre que ele é visto, alguma verdade se perde.',
        type: 'mito'
    },
    {
        id: 'abel',
