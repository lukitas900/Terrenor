...
export const players: Player[] = [
  ...
  },
  {
    ...
    stats: {
      forca: { value: 14, description: '(E:1-2 /B:3-8 /N:9-14 /F:15-19 /D:20)' },
      destreza: { value: 10, description: '(E:1 /B:2-4 /N:5-10 /F:11-19 /D:20)' },
      vitalidade: 38,
      sorte: { value: 15, description: '(E:1-3 /B:4-9 /N:10-15 /F:16-19 /D:20)' },
      pontaria: { value: 15, description: '(E:1-3 /B:4-9 /N:10-15 /F:16-19 /D:20)' },
      observacao: { value: 16, description: '(E:1-4 /B:5-10 /N:11-16 /F:17-19 /D:20)' },
      furtividade: { value: 3, description: '(E:1 /B:2/N:3 /F:4-19 /D:20)' },
      inteligencia: { value: 15, description: '(E:1-3 /B:4-9 /N:10-15 /F:16-19 /D:20)' },
      medicina: { value: 18, description: '(E:1-6 /B:7-12 /N:13-18 /F:19 /D:20)' },
      persuasao: { value: 18, description: '(E:1-6 /B:7-12 /N:13-18 /F:19 /D:20)' },
      poderMagico: { value: 15, description: '(E:1-3 /B:4-9 /N:10-15 /F:16-19 /D:20)' },
      constituicao: { value: 15, description: '(E:1-3 /B:4-9 /N:10-15 /F:16-19 /D:20)' }
    },
    abilities: [
